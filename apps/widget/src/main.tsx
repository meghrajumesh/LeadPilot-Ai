...
function styles(config: {
  ...
  const baseStyle = `
    ...
    .lp-messages { flex: 1; overflow-y: auto; }
  ...
  if (template === "bar") {
    return baseStyle + `
      ...
      .lp-messages { padding: 10px; background: #fff; }
  ...
  if (template === "voice") {
    return baseStyle + `
      ...
      .lp-messages { padding: 16px; background: #f8fafc; }
  ...
  if (template === "terminal") {
    ...
    return baseStyle + `
      ...
      .lp-panel { width: min(${size.w}px + 40px, 90vw); max-width: 480px; height: min(${size.h}px, 540px, 80vh); display: flex; flex-direction: column; overflow: hidden; background: #0d1117; border: 1px solid #30363d; border-radius: 10px; box-shadow: 0 24px 80px rgba(0,0,0,0.6); font-family: ${mono}; animation: lp-scale-in 220ms cubic-bezier(0.16,1,0.3,1); }
      ...
      .lp-messages { padding: 14px; background: #0d1117; }
  ...
  if (template === "command") {
    ...
    return baseStyle + `
      ...
      .lp-messages { padding: 14px; background: #f8fafc; }
